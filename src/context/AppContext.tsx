...
-  const [data, setData] = useStoredState('expressoneves-data', {
-    motoboys: [],
-    lojas: [],
-    jornadas: [],
-    adiantamentos: [],
...
-    const newMotoboy = { ...motoboy, id: Date.now().toString() };
...
-  const updateMotoboy = (id, updatedMotoboy) => {
-    setData(prev => ({
-      ...prev,
-      motoboys: prev.motoboys.map(m => m.id === id ? { ...m, ...updatedMotoboy } : m)
-    }));
...
+    }
   ...
   // Lojas
-  const addLoja = (loja) => {
-    const newLoja = { ...loja, id: Date.now().toString() };
...
-  const updateLoja = (id, updatedLoja) => {
-    setData(prev => ({
-      ...prev,
-      lojas: prev.lojas.map(l => l.id === id ? { ...l, ...updatedLoja } : l)
-    }));
...
+    }
   ...
   // Jornadas
-  const addJornada = (jornada) => {
-    const newJornada = { ...jornada, id: Date.now().toString() };
...
-  const updateJornada = (id, updatedJornada) => {
-    setData(prev => ({
-      ...prev,
-      jornadas: prev.jornadas.map(j => j.id === id ? { ...j, ...updatedJornada } : j)
-    }));
...
+    }
   ...
   // Adiantamentos
-  const addAdiantamento = (adiantamento) => {
-    const newAdiantamento = { ...adiantamento, id: Date.now().toString() };
...
-  const updateAdiantamento = (id, updatedAdiantamento) => {
-    setData(prev => ({
-      ...prev,
-      adiantamentos: prev.adiantamentos.map(a => a.id === id ? { ...a, ...updatedAdiantamento } : a)
-    }));
...
-    const newColaborador = { ...colaborador, id: Date.now().toString() };
...
-  const updateColaborador = (id, updatedColaborador) => {
-    setData(prev => ({
-      ...prev,
-      colaboradores: prev.colaboradores.map(c => c.id === id ? { ...c, ...updatedColaborador } : c)
-    }));
...
+    }
   ...
   // Débitos Pendentes
-  const addDebitoPendente = (debito) => {
-    const newDebito = { ...debito, id: Date.now().toString() };
...
-  const updateDebitoPendente = (id, updatedDebito) => {
-    setData(prev => ({
-      ...prev,
-      debitosPendentes: prev.debitosPendentes.map(d => d.id === id ? { ...d, ...updatedDebito } : d)
-    }));
